...
_allowed_hosts_list = [h.strip() for h in _allowed_hosts_env.split(',') if h.strip()]
ALLOWED_HOSTS = _allowed_hosts_list + ['localhost', '127.0.0.1', '.onrender.com', 'breathe-esg-backend-egph.onrender.com']
